...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('RentalUnits', [
     ...
     {title:'Come relax in the amazing city of Montery' , ownerId:1 , city:'Montery'  ,state: 'CA'  , zipcode:'78944'  , rooms: 4 , bathrooms: 2, distanceFromBeach: 0,lat:'36.6002', lng:'-21.898460' , unitType: "house"  , pool: 'yes'  , price: '1423' , rentalUnitDescription:'Water front house, The house was completely rebuild and decorated by a famous San Francisco architect. A few walking blocks to great restaurants, winery and distillery. World famous hikes are steps away.'  , totalRentals: 0, url:'https://beachitt-app.s3.us-west-1.amazonaws.com/beach-house-cancun.jpeg' , createdAt: new Date() , updatedAt: new Date()},
