...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('RentalUnits', [
    ...
    { title: 'Summerwind Cottage - Sunsets over the Bay', ownerId:2 , city: 'Vallejo' ,state:'CA'  , zipcode:'94736'  , rooms:2  , bathrooms:1 , distanceFromBeach: 0.2 , lat:'38.09998264736481' , lng:'-122.25585937500001' , unitType: "house" , pool: 'no' , price:'350.00'  , rentalUnitDescription:'Enjoy your time on the water at Summerwind. A refreshing, clean, and luxurious cottage providing all of your needs for a relaxing stay.'  , totalRentals: 0 , createdAt: new Date() , updatedAt: new Date() }
   ], {});
  },
