...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('RentalUnits', [
     ...
     {title:'Paradise in Maui' , ownerId:1 , city:'Lahana'  ,state: 'HI'  , zipcode:'78944'  , rooms: 3 , bathrooms: 2, distanceFromBeach: 0,lat:'20.873565', lng:'-156.677427' , unitType: "Apartment"  , pool: 'yes'  , price: '1,423' , rentalUnitDescription:''  , totalRentals: 0, url:'https://beachitt-app.s3.us-west-1.amazonaws.com/house-hawaii' , createdAt: new Date() , updatedAt: new Date()},
     ...
     {title:'Come relax in the amazing city of Montery' , ownerId:1 , city:'Montery'  ,state: 'CA'  , zipcode:'78944'  , rooms: 4 , bathrooms: 2, distanceFromBeach: 0,lat:'36.6002', lng:'-21.898460' , unitType: "house"  , pool: 'yes'  , price: '1423' , rentalUnitDescription:''  , totalRentals: 0, url:'https://beachitt-app.s3.us-west-1.amazonaws.com/beach-house-cancun.jpeg' , createdAt: new Date() , updatedAt: new Date()},
     ...
     {title:'Luxury stay in Laguna beach' , ownerId:2 , city:'Laguna Beach'  ,state: 'CA'  , zipcode:'78944'  , rooms: 4 , bathrooms: 2, distanceFromBeach: 0, lat:'33.541679', lng:'-117.777214', unitType: "house"  , pool: 'yes'  , price: '1,423' , rentalUnitDescription:''  , totalRentals: 0, url:'https://beachitt-app.s3.us-west-1.amazonaws.com/house-caribbean-2.jpeg' , createdAt: new Date() , updatedAt: new Date()},
